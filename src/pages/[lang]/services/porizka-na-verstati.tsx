  ...
  return (
    <section style={{ backgroundColor: bgColor, color: secondaryColor }}>
      ...
      <BackCover>
        <InformationBlock
          title="Лентопил"
          descriptionTop="Ми пропонуємо високоякісну порізку металу за допомогою лентопилів ЧПУ, що дозволяє обробляти заготовки з великою точністю і швидкістю. Завдяки нашому сучасному парку обладнання, ми здатні виконувати великі обсяги робіт будь-якої складності."
      ...
      <div className="sm:px-4 mt-6">
        <InfoCard
          ...
          descriptionCard="У нас є більше 10 лентопилів ЧПУ, здатних різати заготовки діаметром від 10 до 550 мм, що забезпечує гнучкість і можливість працювати з різними типами металу."
        />
        <InfoCard
          aligntText="start"
          direction="row"
