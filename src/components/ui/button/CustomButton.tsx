...
const CustomButton: FC<PropsCustomButton> = ({
  ...
  const buttonClass = {
    ...
    'send-btn':
      'shadow-[0_10px_30px_#000] bg-[#c43c1e] text-[#f9f7dc] text-[13px] md:text-[18px] px-3 py-2  sm:py-2 xl:px-5 xl:py-2 xl:text-[21px] rounded-[10px] hover:bg-[#9e2a1f] hover:text-[#fff] transition-all duration-300 ease-in-out',
  }[variant];
